...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    style={{ background: "rgba(220,228,240,0.50)", backdropFilter: "blur(10px)" }}
    {...props}
  />
))
